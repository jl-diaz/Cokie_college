...
export const StaggeredMenu = ({
  ...
  // El PANEL y las pre-capas se renderizan via portal directamente en <body>
  // para evitar problemas de posicionamiento dentro de la navbar
  const overlayContent = (
    <>
      {/* Pre-capas de color que se deslizan antes del panel */}
  ...
  return (
    // Solo el BOTÓN vive aquí dentro de la navbar
    <div
    ...
    >
      {/* BOTÓN TOGGLE — dentro de la navbar */}
      <button
        ref={toggleBtnRef}
        className="sm-toggle"
      ...
      {/* PANEL + PRE-CAPAS — renderizados en <body> via portal */}
      {typeof document !== 'undefined' && ReactDOM.createPortal(overlayContent, document.body)}
    </div>
  );
};
